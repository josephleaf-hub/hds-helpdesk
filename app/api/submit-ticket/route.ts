    ...
    <table width="580" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.10);max-width:100%;">
        ...
        <td style="background:#060D18;padding:24px 32px;">
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td>
                ${emailLogoWhite(26)}
                <div style="color:#8A97A8;font-size:12px;margin-top:8px;">New Support Ticket</div>
              </td>
      ...
      <tr>
        <td style="background:${bgCol};padding:12px 32px;border-top:1px solid #E2E8EF;">
          ...
          <span style="color:#6B7280;font-size:12px;margin-left:16px;">Open the <a href="${SITE_URL}/admin?ticket=${ticketId}" style="color:#1C64F2;font-weight:600;text-decoration:none;">IT Admin Dashboard</a> to manage this ticket.</span>
        </td>
      </tr>
      <tr>
...
async function sendConfirmationEmail(
  ...
  const html = `<!DOCTYPE html>
<html><head><meta charset="utf-8">${EMAIL_HEAD_STYLE}</head>
